...
!(function (t, e) {
    ...
    class Z extends H {
        ...
        _addTouchEventListeners() {
            ...
            U.find(".carousel-item img", this._element).forEach((t) => {
                ...
                this._pointerEvent
                    ? (P.on(this._element, "pointerdown.bs.carousel", (e) =>
                          t(e)
                      ),
                      P.on(this._element, "pointerup.bs.carousel", (t) => i(t)),
                      this._element.classList.add("pointer-event"))
                    : (P.on(this._element, "touchstart.bs.carousel", (e) =>
                          t(e)
                      ),
    ...
    function Ct(t) {
        for (
            var e = dt(t), i = Ot(t);
            i && Et(i) && "static" === wt(i).position;

        )
            i = Ot(i);
        return i &&
            ("html" === ht(i) ||
                ("body" === ht(i) && "static" === wt(i).position))
            ? e
            : i ||
                  (function (t) {
                      var e =
    ...
    const Be = new Set([
        ...
        ze = (t, e) => {
            ...
            if (e.includes(i))
                return (
                    !Be.has(i) ||
                    Boolean(Re.test(t.nodeValue) || We.test(t.nodeValue))
                );
